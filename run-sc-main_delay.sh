...
# then starts the self-oscillating delay instrument SuperCollider patch using sclang.
...
# Define the path to your main_delay.scd script
SCLANG_SCRIPT="/usr/local/sc-patches/sc-store/main_delay.scd"
