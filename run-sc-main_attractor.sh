...
# then starts the Phase-Space Attractor SuperCollider patch using sclang.
...
# Define the path to your main_attractor.scd script
SCLANG_SCRIPT="/usr/local/sc-patches/sc-store/main_attractor.scd"
